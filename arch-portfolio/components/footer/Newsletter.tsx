...
// Recreation of the site's EmailCapture for the standalone review app (the real
// one pulls in js-cookie, @/lib/validation and an /api/subscribe route this app
// doesn't have). Same states and copy; posts to the real endpoint so a submit
// never fakes success — it either subscribes or shows the error.
import { useState } from "react";

const ENDPOINT = "https://blueprintstudio.ai/api/subscribe";
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(ENDPOINT, {
        ...
        body: JSON.stringify({ email, source: "arch_footer_newsletter" }),
      });
