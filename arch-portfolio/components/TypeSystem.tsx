          ...
          <div className="flex w-[596px] shrink-0 flex-col gap-16 max-[1200px]:w-[46%] max-[1024px]:w-full">
            ...
            <div className="flex min-h-[70px] items-start max-[860px]:min-h-[46px]">
              <div
                ...
                className={`caret w-fit max-w-full cursor-text overflow-hidden whitespace-nowrap pr-0.5 leading-[1.1] text-[#181818] caret-[#181818] outline-none max-[860px]:!text-headline-mobile ${
...
export default function TypeSystem() {
  return (
    <section className="flex flex-col gap-32 px-edge pb-section pt-16">
      <TypeGroup group="display" tag="arch-display" serif />
      <TypeGroup group="text" tag="arch-text" serif={false} />
    </section>
  );
}
