// components/service-page/service-design/PrimarySolutions.tsx
import { motion } from 'framer-motion';
import { ArrowRight } from 'lucide-react';
import Link from 'next/link';
import { Users, Workflow, LineChart, Lightbulb, Search } from 'lucide-react';

const solutions = [
  {
    name: "Customer Journey Mapping",
    price: "Starting from $3,499",
    image: "/images/solutions/customer-journey.webp",
  ...
  },
  {
    ...
    image: "/images/solutions/service-blueprint.webp",
  ...
  },
  {
    ...
    image: "/images/solutions/experience-optimization.webp",
    className: "col-span-1 row-span-1",
    icon: LineChart
  },
  {
    ...
    image: "/images/solutions/service-innovation.webp",
    ...
    <section id="solutions" className="py-24">
      <div className="container px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-12">Popular Service Design Solutions</h2>
