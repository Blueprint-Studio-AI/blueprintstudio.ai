    ...
    <Section className="flex flex-col relative z-20 bg-neutral-100 overflow-hidden">
      ...
      <OuterContainer className="flex-1 flex items-center">
        <InnerContainer className="pt-8 sm:pt-12 lg:pt-16 pb-8 sm:pb-12 lg:pb-16 px-2.5 sm:px-6 relative">
          ...
          {/* Studio Description below */}
          {/* <div className="max-w-3xl mx-auto text-left">
            <p className="text-neutral-600 text-lg leading-relaxed cursor-default">
              Together we help founders across AI, finance, hardware, and crypto connect with customers and grow.
            </p>
          </div> */}
        </InnerContainer>
      </OuterContainer>
