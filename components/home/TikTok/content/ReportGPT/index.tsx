...
export default function IDScanner({ isActive }: ProjectProps) {
    return (
        <div style={{zIndex: '10'}}>
            ...
            <p className="text-black" >Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste natus quasi molestiae debitis earum porro ipsum quaerat, ea necessitatibus atque reprehenderit neque, repellat sed in possimus quisquam, iure nostrum perspiciatis.</p>
