...
/**
 * Arch Network brand-portfolio design tokens.
 * Ported 1:1 from the static prototype, regularised into a coherent scale.
 * Sans/UI = Geist · Mono = Geist Mono · Display = Gascogne Serial.
 */
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        serif: ['"Gascogne Serial"', "Georgia", "serif"],
        numbers: ["var(--font-inter)", "Inter", "-apple-system", "Helvetica Neue", "Arial", "sans-serif"],
      },
      fontSize: {
