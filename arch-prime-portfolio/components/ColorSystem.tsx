...
import EarnCategories from "@/components/EarnCategories";
...
export default function ColorSystem() {
  ...
  const nameInk = darkBg ? "#F3EFD7" : "#181818";
  const roleInk = darkBg ? "rgba(243,239,215,0.72)" : "#525252";
  const aaInk = darkBg ? "#FFFFFF" : "#181818";
      ...
      <div className="statement !gap-16">
        ...
        <div className="flex items-start gap-gutter max-[1200px]:gap-14 max-[1024px]:flex-col max-[1024px]:gap-11">
          ...
          <div className="flex w-[596px] shrink-0 flex-col gap-8 max-[1200px]:w-[46%] max-[1024px]:w-full">
            <Tag>prime-{selected.name.toLowerCase().replace(/\s+/g, "-")}</Tag>
        ...
        {/* Earn category fields — inside the same construction lines */}
        <EarnCategories />
      </div>
    </section>
  );
